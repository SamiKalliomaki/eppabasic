...
window.addEventListener('load', function init() {
    ...
    document.body.addEventListener('keydown', function keydown(e) {
        if (e.keyCode == 116 || (e.keyCode == 82 && e.ctrlKey)) {
            ...
            // No shorkcuts in dev mode because reloading the page is more important!
    ...
    // Prevent user from reloading the page by accident
    window.addEventListener('beforeunload', function beforunload(e) {
        //e.preventDefault();
        if (!document.getElementById('dev-mode').checked)
            return e.returnValue = "Are you sure you want to refresh this page. All your code will be lost."
    });
