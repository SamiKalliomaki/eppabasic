...
from filesystem.views import GetDirectoryView, OpenFileView, SaveFileView, DeleteFileView, CreateDirectoryView, DeleteDirectoryView
...
urlpatterns = patterns('',
    ...
    url(r'^delete/', login_required(DeleteFileView.as_view())),
